...
func (c *Client) handleMessage(msg SignalMessage) {
	...
	case "streams-info", "focus-change", "stream-added", "stream-removed", "stream-activated", "stream-deactivated", "size-change", "cursor-position":
		// Forward stream metadata and cursor updates from sharer to all viewers
